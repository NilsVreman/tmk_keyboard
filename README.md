...
### Teensy LC
Quite easy to find arm compiler and standard library for linux, (gcc-arm-none-eabi 7.2.1 worked with no problem).
...
On ubuntu it have worked with the gcc-avr and avr-libc from apt-get's default repository.
